      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Haciendo del inglés tu herramienta clave para el progreso, Talk it up English.</h2>
            <p className="text-xl text-gray-400">Impulsa tu carrera hoy</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Clases Online Personalizadas:

              </h4>
              <p className="text-lg text-gray-400 text-center">Aprende a tu propio ritmo: Clases Online Personalizadas con Talk it up English.</p>
            </div>
