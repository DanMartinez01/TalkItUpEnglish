      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Haciendo del inglés tu herramienta clave para el progreso</h2>
            <p className="text-xl text-gray-400">Clases de Inglés online, personalizadas para vos y tu empresa. Hacemos planes a medida de tus necesidades. </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Material de Estudio</h4>
              <p className="text-lg text-gray-400 text-center">Accede a nuestro exclusivo material de estudio en Talk it up English.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Tips personalizados</h4>
              <p className="text-lg text-gray-400 text-center">Consejos de Profesionales de la Enseñanza.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Amplia tu Vocabulario</h4>
              <p className="text-lg text-gray-400 text-center">Palabras que Impresionan: Amplía tu Vocabulario con Talk it up English.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Cómodo y simple</h4>
              <p className="text-lg text-gray-400 text-center">Aprende desde cualquier parte del mundo.</p>
            </div>
