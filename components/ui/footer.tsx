        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div >
                <p className='text-gray-400 flex flex-row items-center'> TalkItUp es una iniciativa Argentina <span className='ml-1'><Image src={Argentina} alt='Argentinian Flag' width="16" height="8" /></span></p>
                <p className="text-gray-400">

                  Nuestra misión es ayudar a personas y empresas a crecer y ganar herramientas de comunicación. Creemos en el idioma como herramienta fundamental para acercarnos a las distintas culturas y hacer que nuestras ideas, sueños y emprendimientos puedan tener lugar en todo el mundo.
                </p>
              </div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              <li className="ml-4">
                <Link href={"https://www.instagram.com/talkitup_english/"} className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Instagram">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="ml-4">
                <Link href={"https://www.linkedin.com/company/talk-it-up-english"} className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; TalkItUpEnglish. All rights reserved.</div>
